...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getHelloControllerService()
    {
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\HelloController', $this));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\LiestingRepository' => ['privates', 'App\\Repository\\LiestingRepository', 'getLiestingRepositoryService', false],
        ], [
            'App\\Repository\\LiestingRepository' => '?',
        ])));
    ...
    /**
     * Gets the private 'App\Repository\LiestingRepository' shared autowired service.
     *
     * @return \App\Repository\LiestingRepository
     */
    protected function getLiestingRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\LiestingRepository.php';

        return $this->privates['App\\Repository\\LiestingRepository'] = new \App\Repository\LiestingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
